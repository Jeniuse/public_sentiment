...
class hhtcsSpider(scrapy.Spider):
    ...
    start_urls = [
        "http://gdj.beijing.gov.cn/so/s?qt=%s&siteCode=1100000109&tab=all&timeOption=1&days=60&sort=dateDesc&keyPlace=0"%"直播卫星",
        "http://gdj.beijing.gov.cn/so/s?qt=%s&siteCode=1100000109&tab=all&timeOption=1&days=60&sort=dateDesc&keyPlace=0"%"中星九号",
        "http://gdj.beijing.gov.cn/so/s?qt=%s&siteCode=1100000109&tab=all&timeOption=1&days=60&sort=dateDesc&keyPlace=0"%"扶贫工程"
    ]
